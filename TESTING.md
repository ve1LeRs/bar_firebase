...
// Тестировать одно уведомление
testSingleNotification('confirmed')
testSingleNotification('preparing')
testSingleNotification('ready')
testSingleNotification('completed')
testSingleNotification('cancelled')
